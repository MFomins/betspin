...
if (function_exists('acf_add_local_field_group')) :
    ...
    if (function_exists('acf_add_local_field_group')) :
        ...
        acf_add_local_field_group(array(
            'key' => 'group_60374608801c7',
            'title' => 'Hreflang',
            'fields' => array(
                array(
                    'key' => 'field_6037460d88623',
                    'label' => 'Enable hreflang',
                    'name' => 'enable_hreflang',
                    'type' => 'true_false',
                    'instructions' => 'Enable option to add hreflang for this page.',
                    'required' => 0,
                    'conditional_logic' => 0,
                    'wrapper' => array(
                        'width' => '',
                ...
                array(
                    'key' => 'field_6037462c88624',
                    'label' => 'Hreflang',
                    'name' => 'hreflang',
                    'type' => 'text',
                    'instructions' => 'Add hreflang for this page. Use correct case e.g en-CA',
                    'required' => 0,
                    'conditional_logic' => array(
                        array(
                            array(
                                'field' => 'field_6037460d88623',
                                'operator' => '==',
                                'value' => '1',
                            ),
                        ),
